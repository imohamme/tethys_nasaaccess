#* FILE:    nasaaccess MAIN functions
# * DATE:    3/28/18
...
def send_email(to_email, unique_id):
    ...
    from_email = 'nasaaccess.2022@gmail.com'
        ...
        <html>
            ...
            <body>
                <p>Hello,
                   ...
                   <a href="http://127.0.0.1:8000/apps/nasaaccess">
                        http://127.0.0.1:8000/apps/nasaaccess
                   </a>
                   <br>
                   Your unique access code is: <strong>""" + unique_id + """</strong></br>
                   <br>
                   Note: The data will be deleted within 48 hours of receiving this email.</br>
                </p>
            </body>
        <html>
    """
    ...
    gmail_user = 'nasaaccess.2022@gmail.com'
